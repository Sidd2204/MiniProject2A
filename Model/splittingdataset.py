...
data = pd.read_csv('/Users/abhimanyudeshmukh/code/projectsem5/model training/wholewordset.csv')

# Group by difficulty and sample 80 words from each level for testing data
test_data = data.groupby('difficulty').apply(lambda x: x.sample(n=80, random_state=42))
